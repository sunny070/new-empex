...
namespace App\Http\Livewire\Admin\ChangeRequest\Verify;
...
class BasicInfo extends Component
{
	...
	{
		return redirect(route('admin.verify.change.request'));
	}
	...
	{
		return view('livewire.admin.change-request.verify.basic-info');
	}
}
