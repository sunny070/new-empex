...
class Address extends Component
{
	...
	public function verifyChange()
	{
		...
		SendStatusSms::dispatch($this->user->mobile_no, 'change address', 'verified')->delay(now()->addSeconds(5));
	...
	{
		return view('livewire.district.changes.verification.detail.address');
	}
}
