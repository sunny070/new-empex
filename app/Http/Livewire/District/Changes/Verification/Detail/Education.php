...
class Education extends Component
{
	...
	public function verifyChange()
	{
		...
		SendStatusSms::dispatch($this->user->mobile_no, 'change educational details', 'verified')->delay(now()->addSeconds(5));
	...
	{
		return view('livewire.district.changes.verification.detail.education');
	}
}
