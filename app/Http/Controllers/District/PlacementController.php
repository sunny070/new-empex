...
class PlacementController extends Controller
{
    ...
    public function index(Request $request, District $district)
    {
        ...
        $districts = District::query()->whereIn('id',$authDistricts)->get(['id', 'name']);

        abort_if(!in_array($district->id,$authDistricts),401,'Invalid district code');
        ...
        return view('district-admin.placement.index', compact('placements', 'search', 'sort', 'districts', 'district'));
    }
    ...
    public function createPlacement()
    {
        ...
        return view('district-admin.createPlacement');
    }
