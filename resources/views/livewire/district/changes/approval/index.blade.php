	...
	<div class="rounded w-full">
		...
		<div id="tab-contents" class="mt-4">
			<div id="basicInfo" class="">
				@livewire('district.changes.approval.info')
			</div>
			<div id="address" class="hidden">
				@livewire('district.changes.approval.address')
			</div>
			<div id="education" class="hidden">
				@livewire('district.changes.approval.education')
			</div>
			<div id="experience" class="hidden">
				@livewire('district.changes.approval.experience')
			</div>
			<div id="transfer" class="hidden">
				@livewire('district.changes.approval.transfer')
			</div>
		</div>
	</div>
</div>