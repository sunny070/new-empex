	...
	<div class="rounded w-full">
		...
		<div id="tab-contents" class="mt-4">
			<div id="basicInfo" class="">
				@livewire('district.changes.verification.info')
			</div>
			<div id="address" class="hidden">
				@livewire('district.changes.verification.address')
			</div>
			<div id="education" class="hidden">
				@livewire('district.changes.verification.education')
			</div>
			<div id="experience" class="hidden">
				@livewire('district.changes.verification.experience')
			</div>
			<div id="transfer" class="hidden">
				@livewire('district.changes.verification.transfer')
			</div>
		</div>
	</div>
</div>