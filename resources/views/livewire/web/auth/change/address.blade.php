			...
			<div class="flex justify-between md:justify-center">
				...
				<div class="md:ml-2 w-1/2 md:w-full text-right md:text-left">
					<button type="submit" wire:click.prevent='submit' wire:loading.attr="disabled"
						...
						$sameAsPermanent==false && $buttonDisable==true ? 'disabled' : '' }}
						class="uppercase focus:outline-none border border-transparent py-1 px-5 rounded text-center text-white {{ $sameAsPermanent == false && $buttonDisable == true ? 'bg-gray-400 cursor-not-allowed' : 'bg-empex-green hover:bg-green-500' }} font-medium">
