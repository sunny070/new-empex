<div class="mt-10">
	<div class="text-black text-lg">Transfer</div>
	<div class="grid grid-cols-1 md:grid-cols-2 md:gap-4 mt-2">
		<div>
			...
			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				...
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $origin !== null ? $origin->district->name :
					'-' }}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">City/Village</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $origin !== null ? $origin->village : '-' }}
				</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">RD Block</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $origin !== null ? $origin->rdBlock->name : '-'
					}}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">Police Station</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $origin !== null ? $origin->policeStation->name
					: '-' }}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">Post Office</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $origin !== null ? $origin->postOffice->name :
					'-' }}</div>
			</div>
		...
		<div>
			...
			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">State</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $transfer !== null ? $transfer->state->name :
					'-' }}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">District</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $transfer !== null ? $transfer->district->name
					: '-' }}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">City/Village</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $transfer !== null ? $transfer->village :
					'-' }}</div>
			</div>
			...
			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">Pincode</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $transfer !== null ? $transfer->pin_code : '-'
					}}</div>
			</div>

			<div class="flex justify-between md:grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
				<div class="text-gray-400">House No</div>
				<div class="font-semibold col-span-2 text-right md:text-left">{{ $transfer !== null ? $transfer->house_no : '-'
					}}</div>
			</div>
		</div>
	</div>
