<div>
    ...
    <div class="m-auto mt-5">
      <button wire:click.prevent='openApproveDialog' class="bg-green-600 hover:bg-green-500 text-white font-semibold hover:text-white py-2 px-4 rounded">
        Approve
      </button>
		...
		<x-slot name="footer">
			<div class="flex flex-row">
				...
				<div class="flex flex-col ml-4 w-1/2">
					<button
						type="submit"
						wire:click.prevent='closeApproveDialog'
