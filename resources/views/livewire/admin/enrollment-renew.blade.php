<div class="flex flex-col w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($renews as $renew)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-medium">
                                        <button
                                            wire:click="openRejectDialog({{ $renew->id }}, {{ $renew->user->id }})"
                                            class="text-red-600 dark:text-red-500 hover:text-indigo-900 dark:hover:text-red-700">Reject</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm" colspan="6">Renew application not
                                        found</td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <x-jet-dialog-modal wire:model="rejectDialog">
        ...
        <x-slot name="content">
            ...
            <textarea placeholder="Rejection Reason" wire:model="rejectionNote" placeholder="" name="notes" id="notes" cols="30" rows="3"
