<div>
	<div class="grid grid-cols-1 gap-4 md:grid-cols-2 p-4">
		...
		<div class="p-2 text-center w-full col-span-2">
			...
			<div class="w-full relative text-left md:w-1/2 md:mx-auto">
				<label class="tracking-wide text-gray-600 text-xs">
					NCO Code*
				</label>
	...
	<div class="pb-5 pt-10">
		<div class="flex justify-between md:justify-center">
			...
			<div class="md:mr-2 w-1/2 md:w-full text-left md:text-right">
				<button @click="ncoEditDialog = false"
					class="uppercase focus:outline-none py-1 border-empex-green px-5 rounded text-center text-empex-green bg-white hover:bg-gray-100 font-medium border">Close</button>
			</div>
	...
	<div class="text-center">
		<button
			class="bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-1 px-4 border border-green-500 hover:border-transparent rounded">Save</button>
