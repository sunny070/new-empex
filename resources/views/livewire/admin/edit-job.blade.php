<div class="bg-white rounded border p-5 w-full">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
    ...
    <div class="w-full relative md:col-span-2" wire:ignore>
      ...
      <textarea id="description2" wire:model.debounce.9999999ms="description" wire:key="description"
  ...
  {{-- <div>
    ...
    <div class="font-bold">NCO details</div>
    ...
    <button type="button" wire:click='showNcoSelectionModal'
    ...
    @if (count($checkDataForStore) > 0)
    <span class="text-empex-green ml-3">{{ count($checkDataForStore) }} NCO family class selected</span>
    @endif
  </div> --}}
