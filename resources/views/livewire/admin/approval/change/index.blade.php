	...
	<div class="rounded w-full">
		...
		<div id="tab-contents" class="mt-4">
			<div id="basicInfo" class="">
				@livewire('admin.approval.change.info')
			</div>
			<div id="address" class="hidden">
				@livewire('admin.approval.change.address')
			</div>
			<div id="education" class="hidden">
				@livewire('admin.approval.change.education')
			</div>
			<div id="experience" class="hidden">
				@livewire('admin.approval.change.experience')
			</div>
			<div id="transfer" class="hidden">
				@livewire('admin.approval.change.transfer')
			</div>
		</div>
	</div>
</div>