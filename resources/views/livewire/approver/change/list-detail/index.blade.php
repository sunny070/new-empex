	...
	<div class="rounded w-full">
		...
		<div id="tab-contents" class="mt-4">
			<div id="basicInfo" class="">
				@livewire('approver.change.list-detail.info')
			</div>
			<div id="address" class="hidden">
				@livewire('approver.change.list-detail.address')
			</div>
			<div id="education" class="hidden">
				@livewire('approver.change.list-detail.education')
			</div>
			<div id="experience" class="hidden">
				@livewire('approver.change.list-detail.experience')
			</div>
			<div id="transfer" class="hidden">
				@livewire('approver.change.list-detail.transfer')
			</div>
		</div>
	</div>
</div>