						...
						<table class="min-w-full">
							<thead>
								<tr>
									...
									<th class="px-1 py-1 text-left text-sm font-normal text-gray-400">Reason for leaving
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<td class="px-1 py-1 whitespace-nowrap">{{ date('d M Y', strtotime($exp->from)) }}
									</td>
						...
						<table class="min-w-full">
							...
							<tbody>
								...
								<tr>
									...
									<td class="px-1 py-1 whitespace-nowrap">{{ date('d M Y', strtotime($ori->from)) }}
									</td>
									<td class="px-1 py-1 whitespace-nowrap">
										@if ($ori->is_working == 1)
										Present
