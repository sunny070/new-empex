...
<div class="w-full bg-white py-12">
    <div class="max-w-7xl mx-auto px-4">
        ...
        {{-- placement card --}}
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            <div class="empex-gray rounded border flex w-full">
                <div class="w-2/2 px-5 py-3 rounded-l">
                    <div>
                ...
                <div class="w-2/3 py-3 rounded-r">
                    <div>
                        <div class="text-xl text font-semibold">Placement</div>
                        <div class="-mt-1 text-empex-green font-medium">
            ...
            <div class="empex-gray rounded border flex w-full">
                ...
                <div class="w-2/3 py-3 rounded-r">
                    <div>
                        <div class="text-xl text font-semibold"> <span id="total-visitor">{{ $totalVisitors }}</span>
                        </div>
                        <div class="-mt-1 text-empex-green font-medium">
            ...
            <div class="empex-gray rounded border flex w-full">
                ...
                <div class="w-2/3 py-3 rounded-r">
                    <div>
                        <div class="text-xl text font-semibold"> <span id="today-visitor">{{ $todaysVisitors }}</span>
                        </div>
                        <div class="-mt-1 text-empex-green font-medium">
        ...
        <div class="mt-5 grid grid-cols-1 md:grid-cols-3 md:gap-4">
            <div class="col-span-2 border rounded p-5 order-2 md:order-1">
                ...
                <div class="my-5 canvas-content">
                    ...
                    <div role='status'
                        class='nco-skeleton w-full nco-status p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700'>
