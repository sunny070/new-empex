...
@section('content')
    <div class="py-5" x-cloak x-data="{ rejectDialog: false, verifyDialog: false, ncoDialog: false, ncoEditDialog: false }">
        <div class="max-w-7xl mx-auto px-4">
            {{-- HEADING --}}
            <h1 class="text-3xl text-gray-600 dark:text-gray-200 font-semibold">Verify employee exchange applications</h1>
            <div class="lg:flex items-center justify-between py-4 space-y-2 sm:space-y-4 md:space-y-2 lg:space-y-0">
                <table class="table-auto w-screen">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-gray-700 p-2">Basic Info</td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">Full Name</td>
                            <td class="p-2">{{ $basicInfo->full_name }}</td>
                            <td class="text-gray-500 p-2">Date of Birth</td>
                            <td class="p-2">{{ $basicInfo->dob }}</td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">Gender</td>
                            <td class="p-2">{{ $basicInfo->gender }}</td>
                            <td class="text-gray-500 p-2">Phone</td>
                        ...
                        <tr>
                            <td class="text-gray-500 p-2">Father/Mother</td>
                            <td class="p-2">{{ $basicInfo->parents_name }}</td>
                            <td class="text-gray-500 p-2">Marital Status</td>
                            <td class="p-2">{{ $basicInfo->marital_status }}</td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">Religion</td>
                            <td class="p-2">{{ $basicInfo->religion->name }}</td>
                            <td class="text-gray-500 p-2">Caste</td>
                            <td class="p-2">{{ $basicInfo->caste }}</td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">Aadhaar</td>
                            <td class="p-2">{{ $basicInfo->aadhar_no }}</td>
                            <td class="text-gray-500 p-2">Language Spoken</td>
                            <td class="p-2"></td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">Language Read</td>
                            <td class="p-2"></td>
                            <td class="text-gray-500 p-2">Language Write</td>
                            <td class="p-2"></td>
                        </tr>
                        <tr class="border-t-2 border-b-2">
                            <td class="text-gray-700 p-2">Physically Challenged</td>
                            <td class="p-2"> {{ $basicInfo->physically_challenge ? 'Yes' : 'No' }} </td>
                        </tr>
                        {{-- @foreach ($addresses as $address)
                            ...
                            <tr>
                                <td class="text-gray-500 p-2">State</td>
                                <td class="p-2">{{ $address->state->name }}</td>
                                <td class="text-gray-500 p-2">District</td>
                                <td class="p-2">{{ $address->district->name }}</td>
                            </tr>
                            <tr>
                                <td class="text-gray-500 p-2">City/Village</td>
                                <td class="p-2">{{ $address->village }}</td>
                                <td class="text-gray-500 p-2">RD Block</td>
                                @if ($address->rdBlock)
                                    <td class="p-2">{{ $address->rdBlock->name }}</td>
                                @endif
                            </tr>
                            <tr>
                                <td class="text-gray-500 p-2">Police Station</td>
                                <td class="p-2">{{ $address->policeStation->name }}</td>
                                <td class="text-gray-500 p-2">Post Office</td>
                                <td class="p-2">{{ $address->postOffice->name }}</td>
                            </tr>
                            <tr>
                                <td class="text-gray-500 p-2">PIN Code</td>
                                <td class="p-2">{{ $address->pin_code }}</td>
                                <td class="text-gray-500 p-2">House No.</td>
            ...
            <div class="lg:flex items-center justify-between py-4 space-y-2 sm:space-y-4 md:space-y-2 lg:space-y-0">
                <table class="table-auto w-screen">
                    <tbody>
                        <tr class="border-t-2">
                            <td colspan="8" class="text-gray-700 p-2">Education Qualifications</td>
                        </tr>
                        <tr>
                            <td class="text-gray-500 p-2">#</td>
                            <td class="text-gray-500 p-2">Qualification</td>
                            <td class="text-gray-500 p-2">Board/University</td>
                            <td class="text-gray-500 p-2">Subject</td>
                            <td class="text-gray-500 p-2">Major/Core</td>
                            <td class="text-gray-500 p-2">Division/Rank</td>
                            <td class="text-gray-500 p-2">Passing Year</td>
                            <td class="text-gray-500 p-2">Duration</td>
                            <td class="text-gray-500 p-2">Document</td>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td class="p-2">
                                    @if ($qualification->certificate != null)
                                        {{-- <a target="_blank" href="{{ $qualification->certificate }}">View</a> --}}
                                        <a target="_blank"
            ...
            <div class="lg:flex items-center justify-between py-4 space-y-2 sm:space-y-4 md:space-y-2 lg:space-y-0">
                <table class="table-auto w-screen">
                    <tbody>
                        <tr class="border-t-2">
                            <td colspan="2" class="text-gray-700 p-2">Experience</td>
                            <td>{{ count($experiences) > 0 ? 'Yes' : 'No' }}</td>
                        </tr>
                        @if (count($experiences) > 0)
                            <tr>
                                <td class="text-gray-500 p-2">#</td>
                                <td class="text-gray-500 p-2">Designation</td>
                                <td class="text-gray-500 p-2">From</td>
                                <td class="text-gray-500 p-2">To</td>
                                <td class="text-gray-500 p-2">Department/Company</td>
                                <td class="text-gray-500 p-2">Salary</td>
                                <td class="text-gray-500 p-2">Reason for leaving</td>
                            </tr>
            ...
            <div class="md:px-6 md:py-4">
                <div class="grid grid-cols-1 md:gap-4 gap-1 mt-2">
                    <div class="flex justify-between md:grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-1 md:gap-4">
                        <div class="text-gray-500">NCO on card</div>
                    ...
                    <div class="flex justify-between md:grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-1 md:gap-4">
                        <div class="text-gray-500">NCO Detail</div>
                        <div class="col-span-4 text-right md:text-left">
            ...
            <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
                ...
                x-transition:enter-end="opacity-100" x-transition:leave="transition duration-300"
                x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                <div class="relative w-3/4 mx-2 sm:mx-auto my-10 opacity-100">
                    <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20 h-70"
            ...
            {{-- verify modal --}}
            <form
                action="{{ route('admin.post.verify.application', [$basicInfo->id, 'Approved', 'admin.verify.new.application']) }}"
                method="post">
                @csrf
                <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
