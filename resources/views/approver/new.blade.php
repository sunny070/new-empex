...
@section('title', 'Approver - New Application')
...
<div class="max-w-7xl mx-auto px-4 my-5 flex">
  <div class="w-full mb-5 md:mb-0">
    ...
    <div class="md:px-6 md:py-4">
      <div class="text-gray-400">Verification Notes: <span class="text-black">{{ $basicInfo->notes ?? '-' }}</span>
      </div>
    </div>
  ...
  {{-- reject modal --}}
  <form action="{{ route('verifier.verify', [$basicInfo->id, 'Rejected', 'approver']) }}" method="post">
    @csrf
    <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
